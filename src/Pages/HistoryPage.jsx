            ...
            <div className="card p-2">
              ...
              <section>
                <p className="text-justify mb-3 pt-2">
                  Aujourd'hui, les vélo-mobiles sont toujours utilisés à
                  diverses fins, notamment pour les déplacements, les voyages et
                  les promenades récréatives. Les conceptions continuent
                  d'évoluer avec les avancées dans les matériaux et la
                  technologie, contribuant au développement continu de ces
                  véhicules propulsés par l'homme profilés.
                </p>
              </section>
            </div>
<br></br>
            <div className="card p-2">
                <h3 className="mb-3">
                    VéloMobiles une page d'histoire 
              </h3>
              <p>
